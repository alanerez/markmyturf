...
if ( ( 'add' == $mode ) || ( 'edit' == $mode ) ) {
	echo '<br>';
	pb_backupbuddy::alert( 'DISCONTINUATION NOTICE: Please upgrade to using the newer BackupBuddy Stash (v2) Remote Destination. This version (v1) is old and will cease to work September 27, 2016.' );
	echo '<br><br>';
}
