...
class pb_backupbuddy_destination_stash { // Change class name end to match destination name.
	...
	public static function send( $settings = array(), $file, $send_id = '', $delete_after = false, $clear_uploads = false ) {
		...
		pb_backupbuddy::status( 'warnings', 'DISCONTINUATION NOTICE: Please upgrade to using the newer BackupBuddy Stash (v2) Remote Destination. This version (v1) is old and will cease to work September 27, 2016.' );
