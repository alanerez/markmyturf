...
// ——————————————————————————————————————————————————
// PbuilderTextScramble
// ——————————————————————————————————————————————————

var PbuilderTextScramble = function () {
  function PbuilderTextScramble(el) {
  ...
  PbuilderTextScramble.prototype.setText = function setText(newText) {
    var _this = this;
  ...
  PbuilderTextScramble.prototype.update = function update() {
    var output = '';
    var complete = 0;
    for (var i = 0, n = this.queue.length; i < n; i++) {
      ...
      if (this.frame >= end) {
        ...
        output += '<span class="pbuilder_scramble_dud">' + char + '</span>';
      } else {
        output += from;
      }
    }
  ...
  PbuilderTextScramble.prototype.randomChar = function randomChar() {
    return this.chars[Math.floor(Math.random() * this.chars.length)];
  };

  return PbuilderTextScramble;
}();